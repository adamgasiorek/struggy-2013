...
<?php } ?>
<a   class="main" href="javascript:popup_show( 'color',  'color_drag',  'color_exit', 'element', 60,  60, 'chat', false);">Kolor</a>
<a   class="main" href="javascript:popup_show('smiley', 'smiley_drag', 'smiley_exit', 'element', 70,  70, 'chat', false);">Emotinky</a>
<a   class="main" href="javascript:popup_show( 'about',  'about_drag',  'about_exit', 'element', 80,  80, 'chat', false);">Pomoc</a>


<table class="main">
<tr>
  <td><div id="header_messages"><?=$chat_list[1];?></div><div id="messages"></div></td>
  <td>
    <!------
